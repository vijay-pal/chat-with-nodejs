package com.example.vijay.clientchat.widget;
...
import com.example.vijay.clientchat.adapter.SearchAdapter;
import com.example.vijay.clientchat.models.SearchResponse;
import com.example.vijay.clientchat.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void initSearchView() {
        ...
        mAdapter = new SearchAdapter(mContext, new ArrayList<SearchResponse.People>(), suggestionIcon, ellipsize);
        setAdapter(mAdapter);
    }
     ...
     */
    public void setSuggestions(List<SearchResponse.People> suggestions) {
